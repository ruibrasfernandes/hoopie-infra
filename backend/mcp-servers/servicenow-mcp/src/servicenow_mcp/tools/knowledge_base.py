...
class CreateArticleParams(BaseModel):
    ...
    article_type: str = Field("html", description="The type of article. Options are 'text' or 'wiki'. text lets the text field support html formatting. wiki lets the text field support wiki markup.")
